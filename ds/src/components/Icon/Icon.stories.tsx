...
/**
 * Каталог: 18 из 19 категорий библиотеки Figma (78:3664). Cursor не
 * входит — там составные многослойные иконки с тенью, не ложатся
 * в модель path+currentColor остальных (см. icons.generated.ts).
 */
